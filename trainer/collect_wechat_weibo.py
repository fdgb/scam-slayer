...
KEYWORDS = [
    ...
    "治病偏方", "这种食物不能吃", "防癌食谱",
    "癌症偏方 秘方", "降糖神药", "治百病 秘方", "食物相克 谣言",
    "量子 太赫兹 养生", "磁场 理疗 骗局", "中药 根治 糖尿病",
    # 投资/理财诈骗
    "投资理财稳赚", "副业月入过万", "国家补贴领取",
    "杀猪盘 诈骗", "刷单返利 骗局", "冒充客服 退款", "冒充公检法",
    "内部股 原始股", "数字货币 虚拟币 骗局", "财富自由 被动收入",
    "培训贷 美容贷 套路", "0基础 宝妈 兼职", "打字员 客服兼职 日结",
    # AI/深度伪造
    "AI换脸骗局", "声音克隆诈骗", "深度伪造视频识别",
    # 情感/求助类谣言
    "老人防骗", "微信群谣言", "免费领 红包 骗局",
    "水滴筹 轻松筹 真假", "寻人 求助 转发 谣言", "中奖 诈骗 短信",
    "低价 代购 海淘 骗局", "内部价 名额 福利 领取",
]

# 权威数据目录统一指向 skill 的 references/（与 auto_verdict 一致）。
OUTPUT_DIR = os.path.expanduser("~/.workbuddy/skills/scam-slayer/references/collected_data")
